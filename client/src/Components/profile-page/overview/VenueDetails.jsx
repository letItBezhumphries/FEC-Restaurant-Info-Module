...
function VenueDetails({ cross_street, neighborhood, hours, cuisine, style, dress, parking, transit, payment, chef, special, url, phone, details, parties, party_contact }) {
