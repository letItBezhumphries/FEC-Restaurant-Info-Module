...
const Reservations = () => {
  ...
  const { partySize, date, timeSlot } = formData;
      ...
      <Card.Body as="div" style={cardBodyStyles}>
        <div style={reservationFormStyles}>
          <Form.Group controlId="reservationForm.ControlSelectPartySize" style={formRowStylesA}>
            <Form.Label as="div" id="party-size-label" style={controlLabelStyles}>
              Party Size
            </Form.Label>
          ...
          <Form.Group controlId="reservationForm.ControlSelectDate" style={formRowStylesB}>
            <div style={formColumnStyles}>
              <Form.Label as="div" style={{ display: 'block', fontSize: '14px', fontWeight: '500', lineHeight: '16px', paddingBottom: '4px' }}>
                Date
              </Form.Label>
            ...
            <div style={formColumnStyles}>
              <Form.Label as="div" style={controlLabelStyles}>
                Time
              </Form.Label>
        ...
        <div style={formBtnContainer}>
          <Button size="lg" style={buttonStyles} block>
            Find a table
          </Button>
        </div>
