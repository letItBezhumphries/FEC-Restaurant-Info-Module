...
const HeaderTopNav = () => {
  return (
    ...
    >
      <Nav.Item>
        <Nav.Link href="/home" className="top-bar-link">
          For Restaurateurs
        </Nav.Link>
      </Nav.Item>
      <Dropdown as={NavItem}>
        <Dropdown.Toggle as={NavLink} className="top-bar-link">
          Mobile
        </Dropdown.Toggle>
        <Dropdown.Menu>
      ...
      <Nav.Item>
        <Nav.Link eventKey="help" className="top-bar-link">
          Help
        </Nav.Link>
      </Nav.Item>
      <Dropdown as={NavItem}>
        <Dropdown.Toggle as={NavLink} className="top-bar-language-link">
          EN
        </Dropdown.Toggle>
        <Dropdown.Menu>
